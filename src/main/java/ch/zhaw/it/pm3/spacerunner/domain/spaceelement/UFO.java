...
public class UFO extends Obstacle {
    ...
    private double sinWave(double posX) {
        try {
            return 0.35 * Math.sin(posX * VerticalSpeed.UFO.getSpeed() + 1 + 2 * Math.PI * waveOffset) + 0.5 - 0.5 * visualManager.getElementRelativeHeight(UFO.class);
